...
export async function authenticateWithGithub(app: FastifyInstance) {
  app.withTypeProvider<ZodTypeProvider>().post('/sessions/github', {
    ...
    githubOAuthURL.searchParams.set('client_secret', process.env.GITHUB_OAUTH_CLIENT_SECRET ?? '')
    githubOAuthURL.searchParams.set('redirect_uri', process.env.GITHUB_OAUTH_CLIENT_REDIRECT_URI ?? '')
